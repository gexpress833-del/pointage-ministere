...
<body class="flex flex-col min-h-screen min-h-dvh overflow-x-hidden antialiased">
        ...
        <div id="stepStart" class="w-full">
            <div class="bg-white rounded-2xl shadow p-4 sm:p-5 text-center space-y-4">
                ...
                <button type="button" id="btnSigner"
                    ...
                    <span class="btn-label">Scanner mon visage</span>
                </button>
            </div>
        </div>
    ...
    (function () {
        ...
        async function submitPresence() {
            try {
                if (window.Spinners) Spinners.showOverlay();
                ...
                stopCamera();
                setCameraActive(false);
                if (window.Spinners) Spinners.hideOverlay();
        ...
        btnSigner.addEventListener('click', () => {
            ...
            if (window.Spinners) Spinners.show(btnSigner);
            runFaceSign();
        });
