...
return [
    ...
    'alpha_dash' => 'Le champ :attribute ne peut contenir que des lettres, des tirets et des underscores.',
    ...
    'missing_if_present' => 'Le champ :attribute doit être manquant quand :other est présent.',
    ...
    'percent' => 'Le champ :attribute doit être un pourcentage valide.',
    ...
    'custom' => [
        'photo_reference' => [
            'required' => 'Veuillez télécharger une photo de référence pour la reconnaissance faciale.',
            'image' => 'Le fichier photo doit être une image valide (JPEG, PNG, GIF ou WebP).',
            'mimetypes' => 'La photo doit être au format : :values (JPEG, PNG, GIF ou WebP).',
        ],
        'password' => [
